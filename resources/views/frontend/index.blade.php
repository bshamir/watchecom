            ...
            <div class="row">
                <div class="col-md-4 mb-4 mb-md-0">
                    <a class="category-item" href="{{ route('shop.index', $categories[0]->slug ?? '') }}">
                        ...
                        @endif
                        <strong class="category-item-title"style="margin-top: -124px;">{{ $categories[0]->name ?? '' }}</strong>
                    </a>
                </div>
                <div class="col-md-4 mb-4 mb-md-0">
                ...
                <div class="col-md-4">
                    <a class="category-item" href="{{ route('shop.index', $categories[3]->slug ?? '') }}">
                        ...
                        @endif
                        <strong class="category-item-title" style="margin-top: -124px;">{{ $categories[3]->name ?? '' }}</strong>
                    </a>
                </div>
            </div>
        </section>
                    ...
                    <div class="fruits-choose-wrapper">
                        ...
                        <div class="single-fruits-choose">
                            ...
                            <div class="fruits-choose-content">
                                ...
                                <p>Best Selling 100 % Original in Nepal.</p>
                            </div>
                        </div>
                        <div class="single-fruits-choose">
                            <div class="fruits-choose-serial">
                            ...
                            <div class="fruits-choose-content">
                                ...
                                <p>Let our in-house experts guide you through your own personalised shopping experience.</p>
                            </div>
                        </div>
                    </div>
                </div>
